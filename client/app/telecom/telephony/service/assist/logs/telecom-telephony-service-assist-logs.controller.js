angular.module("managerApp").controller("TelecomTelephonyServiceAssistLogsCtrl", function ($scope, $q, $translate, $stateParams, TelephonyMediator, Telephony, User, Toast, PAGINATION_PER_PAGE) {
    "use strict";
